...
export interface IProfileInterface extends Interface {
  getFunction(nameOrSignature: "getProfile"): FunctionFragment;
...
export interface IProfile extends BaseContract {
  connect(runner?: ContractRunner | null): IProfile;
  ...
  getProfile: TypedContractMethod<
    [_user: AddressLike],
    [IProfile.UserProfileStructOutput],
    "view"
  >;
