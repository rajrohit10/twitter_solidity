...
import { Address, DeploymentInfo, EthereumSignature, PriorityOpTree, PriorityQueueType, TransactionLike } from "./types";
...
export declare function eip712TxHash(transaction: any, ethSignature?: EthereumSignature): string;
