...
import type { ContractDeployer, ContractDeployerInterface } from "../ContractDeployer";
export declare class ContractDeployer__factory {
    static readonly abi: readonly [{
        ...
        readonly inputs: readonly [{
            readonly internalType: "bytes32";
            readonly name: "_keccak256BytecodeHash";
            readonly type: "bytes32";
        }];
        readonly name: "forceDeployKeccak256";
        readonly outputs: readonly [];
        readonly stateMutability: "payable";
        readonly type: "function";
    }, {
    ...
    static connect(address: string, runner?: ContractRunner | null): ContractDeployer;
}
