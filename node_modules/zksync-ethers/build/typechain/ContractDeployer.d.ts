...
export declare namespace ContractDeployer {
    ...
    type ForceDeploymentStructOutput = [
        bytecodeHash: string,
        newAddress: string,
        callConstructor: boolean,
        value: bigint,
...
export interface ContractDeployerInterface extends Interface {
    getFunction(nameOrSignature: "create" | "create2" | "create2Account" | "createAccount" | "extendedAccountVersion" | "forceDeployKeccak256" | "forceDeployOnAddress" | "forceDeployOnAddresses" | "getAccountInfo" | "getNewAddressCreate" | "getNewAddressCreate2" | "updateAccountVersion" | "updateNonceOrdering"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "extendedAccountVersion", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "forceDeployKeccak256", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "forceDeployOnAddress", values: [ContractDeployer.ForceDeploymentStruct, AddressLike]): string;
    encodeFunctionData(functionFragment: "forceDeployOnAddresses", values: [ContractDeployer.ForceDeploymentStruct[]]): string;
    ...
    decodeFunctionResult(functionFragment: "forceDeployKeccak256", data: BytesLike): Result;
...
export interface ContractDeployer extends BaseContract {
    ...
    getFunction(nameOrSignature: "extendedAccountVersion"): TypedContractMethod<[_address: AddressLike], [bigint], "view">;
    getFunction(nameOrSignature: "forceDeployKeccak256"): TypedContractMethod<[
        _keccak256BytecodeHash: BytesLike
    ], [
        void
    ], "payable">;
    getFunction(nameOrSignature: "forceDeployOnAddress"): TypedContractMethod<[
        _deployment: ContractDeployer.ForceDeploymentStruct,
        _sender: AddressLike
    ], [
        void
    ], "payable">;
    getFunction(nameOrSignature: "forceDeployOnAddresses"): TypedContractMethod<[
        _deployments: ContractDeployer.ForceDeploymentStruct[]
    ], [
        void
    ], "payable">;
