...
async function verifyContract({ address, contract: contractFQN, constructorArguments, libraries, noCompile }, hre, runSuper) {
    ...
    if (!Array.isArray(constructorArguments)) {
        ...
        deployArgumentsEncoded =
            '0x' + (await (0, utils_1.encodeArguments)(contractInformation.contractOutput.abi, constructorArguments));
    }
    ...
    let request = {
        ...
        sourceCode: (0, plugin_1.getSolidityStandardJsonInput)(hre, dependencyGraph.getResolvedFiles()),
