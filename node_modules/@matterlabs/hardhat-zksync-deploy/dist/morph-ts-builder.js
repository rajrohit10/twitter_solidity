    ...
    constructor(_steps, _sourceFile, _filePath) {
        ...
        for (let _step of _steps) {
            if (isMorphBuilderInitialStepType(_step)) {
                initialValue = _sourceFile.getVariableDeclaration(v => v.getType().getText().includes(_step.initialVariableType));
                ...
                initialValue = _sourceFile
                    .getStatements().find(ea => ea.getText().startsWith(_step.initialModule))
