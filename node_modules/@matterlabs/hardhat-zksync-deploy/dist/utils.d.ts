...
export declare function getLibraryInfos(hre: HardhatRuntimeEnvironment): Array<MissingLibrary>;
...
export declare function getWallet(hre: HardhatRuntimeEnvironment, privateKey: string, accountNumber: number): Wallet;
