...
exports.getWallet = exports.compileContracts = exports.isValidEthNetworkURL = exports.removeLibraryInfoFile = exports.getLibraryInfos = exports.fillLibrarySettings = exports.generateFullQuailfiedNameString = exports.updateHardhatConfigFile = exports.isHttpNetworkConfig = void 0;
...
function getWallet(hre, privateKey, accountNumber) {
    ...
    if (isHardhatNetworkAccountsConfigStrings(accounts)) {
        ...
        return new zksync_ethers_1.Wallet(accountPrivateKey);
    }
    if (isHardhatNetworkHDAccountsConfig(accounts)) {
        const account = accounts;
        return zksync_ethers_1.Wallet.fromMnemonic(account.mnemonic);
    }
    const account = accounts[accountNumber];
    if (!account) {
        throw new errors_1.ZkSyncDeployPluginError('Account with specified index is not found');
    }
    return new zksync_ethers_1.Wallet(account.privateKey);
}
