...
exports.saveDataToFile = exports.getLatestRelease = exports.download = exports.writeLibrariesToFile = exports.mapMissingLibraryDependencies = exports.findMissingLibraries = exports.generateSolcJSExecutableCode = exports.isVersionInRange = exports.getVersionComponents = exports.pluralize = exports.getZksolcUrl = exports.saltFromUrl = exports.sha1 = exports.isURL = exports.zeroxlify = exports.updateCompilerConf = exports.filterSupportedOutputSelections = void 0;
...
async function getLatestRelease(owner, repo, userAgent, timeout = constants_1.DEFAULT_TIMEOUT_MILISECONDS) {
