...
export declare const COMPILE_AND_DEPLOY_LIBRARIES_INSTRUCTIONS = "To compile and deploy libraries, please run: `yarn hardhat deploy-zksync:libraries --private-key <PRIVATE_KEY>`";
