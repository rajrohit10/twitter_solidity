...
(0, config_env_1.extendConfig)((config, userConfig) => {
    ...
    config.zksolc.settings.optimizer = { ...constants_1.defaultZkSolcConfig.settings.optimizer, ...userConfig?.zksolc?.settings?.optimizer };
    config.zksolc.settings.libraries = { ...constants_1.defaultZkSolcConfig.settings.libraries, ...userConfig?.zksolc?.settings?.libraries };
});
...
(0, config_env_1.subtask)(task_names_1.TASK_COMPILE_SOLIDITY_LOG_COMPILATION_RESULT, async ({ compilationJobs }, hre, runSuper) => {
